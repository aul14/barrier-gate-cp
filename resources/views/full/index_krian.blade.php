            ...
            function wsBarrierGate(WB = null) {
                ...
                scadavisInit({
                    ...
                    ws.onmessage = function(e) {
                        ...
                        sv.storeValue("$forceclosebg1", parseFloat(data.bg1.forceclose));
                        sv.storeValue("$limitclosebg2", parseFloat(data.bg2.limitclose));
                        sv.storeValue("$sensor1bg2", parseFloat(data.bg2.sensor1));
                        sv.storeValue("$sensor2bg2", parseFloat(data.bg2.sensor2));
                        ...
                        sv.storeValue("$forceclosebg2", parseFloat(data.bg2.forceclose));
                        sv.updateValues();
                    }
